...
if __name__ == "__main__" :
    ...
    save_thumb_nail_handler = MessageHandler(
        save_thumb_nail,
        filters=Filters.command(["Savethumbnail@KaliLeechBot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    app.add_handler(save_thumb_nail_handler)
    #
    clear_thumb_nail_handler = MessageHandler(
        clear_thumb_nail,
        filters=Filters.command(["Clearthumbnail@KaliLeechBot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
